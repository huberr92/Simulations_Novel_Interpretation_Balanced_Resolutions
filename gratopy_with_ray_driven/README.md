# Gratopy with ray-driven update
[![DOI for Gratopy](https://zenodo.org/badge/doi/10.5281/zenodo.5221442.svg)](https://doi.org/10.5281/zenodo.5221442)
[![Documentation for Gratopy](https://readthedocs.org/projects/gratopy/badge/?version=latest)](https://gratopy.readthedocs.io/?badge=latest)

**This is an experimental update to the gratopy toolbox for the purposes of simulations supporting the paper ``Richard Huber: A novel interpretation of the Radon transform’s ray- and pixel-driven discretizations under balanced resolutions. Accepted to the SSVM 2025 (Scale Space and Variational Methods in Computer Vision) (2025)
, that contains ray-driven Radon transform and ray-driven backprojection'' for the parallel beam case.** 

**This software should not be seen as full-fledged update of the Gratopy toolbox, but is a more adhoc update with a proper update to the gratopy toolbox containing these methods sure to happen soon**!
